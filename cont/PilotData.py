...
scaled_values = scaler.fit_transform(new_df00bk)
...
ax.scatter(dfscaledC['touches_total'], [68]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['duels_accuracy_total'], [67]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['duels_won_total'], [66]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['duels_lost_total'], [65]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_total'], [64]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_accuracy_total'], [63]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_won_total'], [62]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_lost_total'], [61]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['aerial_duels_accuracy_total'], [60]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['aerial_duels_won_total'], [59]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['aerial_duels_lost_total'], [58]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['possession_total'], [57]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_total'], [56]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_accuracy_total'], [55]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_on_target_total'], [54]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_off_target_total'], [53]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_blocked_total'], [52]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['goals_total'], [51]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['assists_total'], [50]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_total'], [49]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_accuracy_total'], [48]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.50, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_successful_total'], [47]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_forward_total'], [46]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_right_total'], [45]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_left_total'], [44]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_backward_total'], [43]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_final_third_total'], [42]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_final_third_successful_total'], [41]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_long_total'], [40]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_opponents_half_total'], [39]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_opponents_half_accuracy_total'], [38]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_opponents_half_successful_total'], [37]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['through_balls_total'], [36]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['crosses_total'], [35]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['crosses_accuracy_total'], [34]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['crosses_successful_total'], [33]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['crosses_not_corners_total'], [32]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['final_third_entries_total'], [31]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['pen_area_entries_total'], [30]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['put_throughs_total'], [29]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['put_throughs_successful_total'], [28]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['tackles_total'], [27]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['tackles_accuracy_total'], [26]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['tackles_won_total'], [25]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['clearances_total'], [24]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['interceptions_total'], [23]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['recoveries_total'], [22]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['won_contest_total'], [21]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['possession_won_attacking_3rd_total'], [20]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['possession_won_middle_3rd_total'], [19]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['possession_won_defensive_3rd_total'], [18]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_conceded_outside_box_total'], [17]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_conceded_inside_box_total'], [16]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['fifty_fifties_total'], [15]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['fifty_fifties_successful_total'], [14]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['fouls_won_total'], [13]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['fouls_conceded_total'], [12]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['corners_won_total'], [11]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['corner_taken_total'], [10]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['freekick_crosses_total'], [9]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['possession_lost_all_total'], [8]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['att_hd_total_total'], [7]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['own_goals_outside_box_total'], [6]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['own_goals_inside_box_total'], [5]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['cards_yellow_total'], [4]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['cards_red_total'], [3]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['offsides_total'], [2]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
