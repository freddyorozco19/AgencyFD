...
ax.scatter(dfscaledC['touches_total'], [68]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['duels_accuracy_total'], [67]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['duels_won_total'], [66]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['duels_lost_total'], [65]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_total'], [64]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_accuracy_total'], [63]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_won_total'], [62]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['dfl_duels_lost_total'], [61]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['aerial_duels_accuracy_total'], [60]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['aerial_duels_won_total'], [59]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['aerial_duels_lost_total'], [58]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['possession_total'], [57]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_total'], [56]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_accuracy_total'], [55]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_on_target_total'], [54]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_off_target_total'], [53]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['shots_blocked_total'], [52]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['goals_total'], [51]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['assists_total'], [50]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_total'], [49]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
ax.scatter(dfscaledC['passes_accuracy_total'], [48]*len(dfscaledC), color = "#FF0046", s=40, alpha=0.75, linewidth=0.5, zorder=3)
